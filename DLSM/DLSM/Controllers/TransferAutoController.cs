...
namespace DLSM.Controllers
{
    ...
    [SessionCheck]
    public class TransferAutoController : Controller
    {
        ...
        public ActionResult Index()
        {
            ...
            if (Session["UserWhID"] == null) { return RedirectToAction("Index", "Login"); }
        ...
        public JsonResult isCard(int PrdID) {
        

            var isCard = (from p in db.Products 
                          join c in db.Configures on p.Code equals c.Value
                          where p.ID==PrdID && c.Code == "PRD-CARD"
